...
export { default as itemApi } from './item-api/index';
export { default as documentTypeApi } from './document-type-api/index';
...
export * from './item-api/endpoints/index';
export * from './document-type-api/endpoints/index';
